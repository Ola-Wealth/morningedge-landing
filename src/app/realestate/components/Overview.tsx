...
const features = [
  "Built around your listings, clients, and Nigerian market",
      ...
      <div className="max-w-[680px] mx-auto px-6 text-center">
        <FadeIn>
          <p className="text-xs font-medium uppercase tracking-[1.5px] text-brand-blue mb-6">
            What is The AI Edge — Real Estate Edition?
          </p>
          <h2 className="text-[40px] leading-[1.1] font-semibold text-white mb-8">
            Not a course. A coaching programme.
          </h2>
          <div className="text-[rgba(255,255,255,0.6)] text-lg leading-relaxed text-left space-y-4 mb-10">
            ...
            <p>
              ...
              task is applied to your actual listings, clients, and deals. Every
              outcome is specific to your market, your tools, and your
              challenges.
            </p>
            <p>
              You don&apos;t leave with a certificate. You leave with a working
              property AI system — built for the way Nigerian real estate
